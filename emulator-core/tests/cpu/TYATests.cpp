...
class CPU6502TYATests : public ::testing::Test
{
  protected:
    CPU6502 cpu;
...
TEST_F(CPU6502TYATests, WillTYATransferPositiveValueCorrectly)
{
    cpu.Reset();
...
TEST_F(CPU6502TYATests, WillTYASetZeroFlagCorrectly)
{
    cpu.Reset();
...
TEST_F(CPU6502TYATests, WillTYASetNegativeFlagCorrectly)
{
    cpu.Reset();
