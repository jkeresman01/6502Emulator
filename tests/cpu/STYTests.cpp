...
class CPU6502STYTests : public ::testing::Test
{
  protected:
    CPU6502 cpu;
...
TEST_F(CPU6502STYTests, WillSTYStorePositiveValueCorrectlyZeroPage)
{
    ...
    Memory::Write(0x8000, 0x84); // STY Zero Page
...
TEST_F(CPU6502STYTests, WillSTYStoreZeroValueCorrectlyZeroPage)
{
...
TEST_F(CPU6502STYTests, WillSTYStoreNegativeValueCorrectlyZeroPage)
{
...
TEST_F(CPU6502STYTests, WillSTYStorePositiveValueCorrectlyZeroPageX)
{
    cpu.SetRegisterY(0x42);
    ...
    Memory::Write(0x8000, 0x94); // STY Zero Page,X
    Memory::Write(0x8001, 0x10);

    cpu.Step();

    EXPECT_EQ(Memory::Read(0x0011), 0x42);
...
TEST_F(CPU6502STYTests, WillSTYStoreZeroValueCorrectlyZeroPageX)
{
    cpu.SetRegisterY(0x00);
    cpu.SetRegisterX(0x01);
...
TEST_F(CPU6502STYTests, WillSTYStoreNegativeValueCorrectlyZeroPageX)
{
    cpu.SetRegisterY(0xFF);
    cpu.SetRegisterX(0x01);
...
TEST_F(CPU6502STYTests, WillSTYStorePositiveValueCorrectlyAbsolute)
{
    cpu.SetRegisterY(0x42);
    ...
    Memory::Write(0x8000, 0x8C); // STY Absolute
...
TEST_F(CPU6502STYTests, WillSTYStoreZeroValueCorrectlyAbsolute)
{
    cpu.SetRegisterY(0x00);
...
TEST_F(CPU6502STYTests, WillSTYStoreNegativeValueCorrectlyAbsolute)
{
    cpu.SetRegisterY(0xFF);
